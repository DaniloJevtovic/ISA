...
public class MovieShowController {
	...
	public ResponseEntity<MovieShowDto> rateMS(@PathVariable Long id,@PathVariable int grade) {
		MovieShow movieShow = movieShowService.rateMS(id, grade);
		MovieShowDto mShowDto = new MovieShowDto(movieShow);
		return new ResponseEntity<MovieShowDto>(mShowDto, HttpStatus.OK);
	}
}
